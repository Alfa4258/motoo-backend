...
class UserSeeder extends Seeder
{
    ...
    {   
        DB::table('users')->insert([
            ...
            'photo' => 'http://127.0.0.1:8000/images/user/polar-bear.jpg',
            'phone' => '081299875369',
            'job' => 'wasd',
            'team' => 'a',
        ...
        DB::table('users')->insert([
            ...
            'photo' => 'http://127.0.0.1:8000/images/user/cat-3.jpeg',
            'phone' => '081299875369',
            'job' => 'wasd',
            'team' => 'a',
        ...
        DB::table('users')->insert([
            ...
            'photo' => 'http://127.0.0.1:8000/images/user/cat-2.jpeg',
            'phone' => '081299875369',
            'job' => 'wasd',
            'team' => 'a',
            'password' => Hash::make('teknisi12345'),
        ...
        DB::table('users')->insert([
            ...
            'photo' => 'http://127.0.0.1:8000/images/user/pino.png',
            'phone' => '081299875369',
            'job' => 'wasd',
            'team' => 'a',
            'password' => Hash::make('user12345'),
